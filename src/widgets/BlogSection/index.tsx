...
export default function BlogSection({ data, heading, title: directTitle, link_text, link_url, articles: directArticles }: BlogSectionProps) {
            ...
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-4 lg:gap-6">
                    {articles.map((article: any, index: number) => {
                        ...
                        const artUrl = isDynamic ? (article.slug ? `/blog/${article.slug}` : "#") : article.link?.url;
